...
# Support
GROUP = os.environ.get("GROUP", "marvellcs")
CHANNEL = os.environ.get("CHANNEL", "jasebmarvell")
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/marvel886/Marvell-Userbot.git")
