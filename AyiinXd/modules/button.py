...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton ORDER SINI GES [Jaseb]<buttonurl:t.me/jasebmarvell> [proof]<buttonurl:t.me/@bGuktikan> [support]<buttonurl:t.me/marvellcs>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton ORDER SINI GES [Jaseb]<buttonurl:t.me/jasebmarvell> [proof]<buttonurl:t.me/bGuktikan> [support]<buttonurl:t.me/marvellcs>`\
    "
    }
)
